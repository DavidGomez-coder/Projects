...
public class SparseVectorTesting {
    ...
    public static void main(String[] args) {
        ...
        {
            SparseVector.Tree<Character> vector2 = new SparseVector.Node<>(new SparseVector.Unif<>('a'), new SparseVector.Unif<>('b'));
            int vector2Size = 8;
        ...
        {
            SparseVector.Tree<Character> vector3 = new SparseVector.Node<>(
                    new SparseVector.Node<>(new SparseVector.Node<>(new SparseVector.Unif<>('a'), new SparseVector.Unif<>('b')),
                            new SparseVector.Node<>(new SparseVector.Unif<>('c'), new SparseVector.Unif<>('d'))),
                    new SparseVector.Node<>(new SparseVector.Node<>(new SparseVector.Unif<>('e'), new SparseVector.Unif<>('f')),
                            new SparseVector.Node<>(new SparseVector.Unif<>('g'), new SparseVector.Unif<>('h'))));
            int vector3Size = 8;
            StringBuilder result = new StringBuilder();
        ...
        {
            SparseVector.Tree<Character> vector4 = new SparseVector.Node<>(
                    new SparseVector.Node<>(new SparseVector.Unif<>('a'), new SparseVector.Node<>(new SparseVector.Unif<>('b'), new SparseVector.Unif<>('c'))),
                    new SparseVector.Unif<>('d'));
            int vector4Size = 8;
            StringBuilder result = new StringBuilder();
        ...
        {
            SparseVector.Tree<Character> vector5 = new SparseVector.Node<>(new SparseVector.Unif<>('a'),
                    new SparseVector.Node<>(new SparseVector.Unif<>('a'), new SparseVector.Unif<>('b')));
            int vector5Size = 4;
            StringBuilder result = new StringBuilder();
        ...
        {
            SparseVector.Node<Character> n = new SparseVector.Node<>(new SparseVector.Unif<>(INITIAL_ELEM), new SparseVector.Unif<>(INITIAL_ELEM));
            SparseVector.Tree<Character> t = n.simplify();
            check(t instanceof SparseVector.Unif<?>, "Tree should be an instance of Unif");
            check(INITIAL_ELEM == t.get(1, 0), "");
        }

        // Simplify Two Unif Vectors With DifferentValues
        {
            SparseVector.Node<Character> n = new SparseVector.Node<>(new SparseVector.Unif<>(INITIAL_ELEM),
                    new SparseVector.Unif<>((char) (INITIAL_ELEM + 1)));
            SparseVector.Tree<Character> t = n.simplify();
        ...
        {
            SparseVector.Node<Character> un = new SparseVector.Node<>(new SparseVector.Unif<>(INITIAL_ELEM), new SparseVector.Node<>(null, null));
            check(un == un.simplify(), "Tree cannot be simplified, should remain unaltered");

            SparseVector.Node<Character> nu = new SparseVector.Node<>(new SparseVector.Node<>(null, null), new SparseVector.Unif<>(INITIAL_ELEM));
            check(nu == nu.simplify(), "Tree cannot be simplified, should remain unaltered");

            SparseVector.Node<Character> nn = new SparseVector.Node<>(new SparseVector.Node<>(null, null), new SparseVector.Node<>(null, null));
