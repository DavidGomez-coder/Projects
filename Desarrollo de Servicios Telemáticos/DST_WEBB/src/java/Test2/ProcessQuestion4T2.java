 ...
 * @author dgpv2
 */
@WebServlet(name = "ProcessQuestion4T2", urlPatterns = {"/ProcessQuestion4T2"})
public class ProcessQuestion4T2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (userName != null) {
            ...
            out.println("<!DOCTYPE html>\n"
                    ...
                    + "        \n"
                    + "        <!--PREGUNTA 4-->\n"
                    + "        <form class=\"login-form\" action=\"Test2Q5\" method=\"post\">\n"
