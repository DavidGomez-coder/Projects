 ...
 * @author dgpv2
 */
@WebServlet(name = "ProcessQuestion3T2", urlPatterns = {"/ProcessQuestion3T2"})
public class ProcessQuestion3T2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (userName != null) {
            ...
            out.println("<!DOCTYPE html>\n"
                    ...
                    + "        \n"
                    + "        <!--PREGUNTA 3-->\n"
                    + "        <form class=\"login-form\" action=\"Test2Q4\" method=\"post\">\n"
