 ...
 * @author dgpv2
 */
@WebServlet(name = "Test2Q2", urlPatterns = {"/Test2Q2"})
public class Test2Q2 extends HttpServlet {
        ...
        if (userName != null) {
            ...
            out.println("<!DOCTYPE html>\n"
                   ...
                   + "         <font color=\"white\"><b>Nº aciertos:</b></font> <font color=\"#6DC36D\"><b>" + ok_q + "</b></font>\n "
                    ...
                    + "                           onclick=\"location.href = 'ProcessTest2'\"\n"
                    ...
                    + "        \n"
                    + "        <!--PREGUNTA 2-->\n"
                    + "        <form class=\"login-form\" action=\"ProcessQuestion2T2\"\n"
                    + " name=\"T1Q2Form\" value=\"FT1Q2\" method=\"post\">\n"
                    + "            <p class=\"login-head\">PREGUNTA 2</p>\n"
                    + "            <br>\n"
                    + "            <p class=\"login-head-text\">\n"
                    + "                Escoge la respuesta correcta. La construcción de la sentencia \"kill [-señal] 4875\" envía una señal "
                            + "a un proceso con pid = 4875</p>\n"
                    + "            <br>\n"
                    + "            <hr>\n"
                    + "            <br>\n"
                    + "            <div>\n"
                    + "                <label><input type=\"radio\" name=\"T2Q2\" value=\"SI\"> a) SI</label><br>\n"
                    + "                <label><input type=\"radio\" name=\"T2Q2\" value=\"NO\"> b) NO</label><br>\n"
                    + "                <label><input type=\"radio\" name=\"T2Q2\" value=\"A VECES\"> c) A VECES</label><br>\n"
                    + "            </div>\n"
                    + "            <br>\n"
