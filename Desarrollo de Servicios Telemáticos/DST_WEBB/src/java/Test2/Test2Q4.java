 ...
 * @author dgpv2
 */
@WebServlet(name = "Test2Q4", urlPatterns = {"/Test2Q4"})
public class Test2Q4 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (userName != null) {
            ...
            out.println("<!DOCTYPE html>\n"
                    ...
                    + "        \n"
                    + "        <!--PREGUNTA 4-->\n"
                    + "        <form class=\"login-form\" action=\"ProcessQuestion4T2\"\n"
                    + " name=\"T1Form\" value=\"T1Q4\" method=\"post\">\n"
                    + "            <p class=\"login-head\">PREGUNTA 4</p>\n"
                    + "            <br>\n"
                    + "            <p class=\"login-head-text\">\n"
                    + "                Escoge la respuesta correcta. la sentencia \"bg [n]\" reanuda en segundo plano"
                    + "        el proceso con pid = n</p>\n"
                    + "            <br>\n"
                    + "            <hr>\n"
                    + "            <br>\n"
                    + "            <div>\n"
                    + "                <label><input type=\"radio\" name=\"T2Q4\" value=\"SI\"> a) SI</label><br>\n"
                    + "                <label><input type=\"radio\" name=\"T2Q4\" value=\"NO\"> b) NO</label><br>\n"
                    + "                <label><input type=\"radio\" name=\"T2Q4\" value=\"A VECES\"> c) A VECES</label><br>\n"
                    + "            </div>\n"
                    + "            <br>\n"
