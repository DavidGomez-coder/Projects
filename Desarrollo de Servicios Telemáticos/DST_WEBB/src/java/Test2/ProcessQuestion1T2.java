 ...
 *
 */
@WebServlet(name = "ProcessQuestion1T2", urlPatterns = {"/ProcessQuestion1T2"})
public class ProcessQuestion1T2 extends HttpServlet {

    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        String userName = LoginManager.getLoginName(request);
        if (userName != null) {
            String user_answer = request.getParameter("T2Q1");
            System.out.println("RESPUESTA DEL USUARIO P1: " + user_answer);
            String correct_mess = "";
            System.out.println(user_answer);
            if (!Test2Manager.isCorrect("1", user_answer)) {
                System.out.print("Respuesta incorrecta");
                correct_mess = "<font color=\"red\"><b>Respuesta incorrecta</b></font>. La respuesta correcta era: "
                        + Test2Manager.getCorrectAnswer("1");
            } else {
            ...
            out.println("<!DOCTYPE html>\n"
                    ...
                    + "        \n"
                    + "        <!--PREGUNTA 1-->\n"
                    + "        <form class=\"login-form\" action=\"Test2Q2\" method=\"post\">\n"
