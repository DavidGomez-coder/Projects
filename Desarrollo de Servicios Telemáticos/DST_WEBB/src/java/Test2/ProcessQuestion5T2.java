 ...
 * @author dgpv2
 */
@WebServlet(name = "ProcessQuestion5T2", urlPatterns = {"/ProcessQuestion5T2"})
public class ProcessQuestion5T2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (userName != null) {
            String user_answer = request.getParameter("T2Q5");
            System.out.println("RESPUESTA DEL USUARIO P5: " + user_answer);
            String correct_mess;
            System.out.println(user_answer);
            if (!Test2Manager.isCorrect("5", user_answer)) {
                System.out.println("Respuesta incorrecta");
                correct_mess = "<font color=\"red\"><b>Respuesta incorrecta</b></font>. La respuesta correcta era: "
                        + Test2Manager.getCorrectAnswer("5");
            } else {
            ...
            out.println("<!DOCTYPE html>\n"
                    ...
                    + "            <ul>\n"
                    + "                <li><br></li>\n"
                    + "                <li><p style=\"text-align: center; color:white;\">TEST2-" + userName + "</p></li>\n"
                    + "                <li><br></li>\n"
                    + "                <hr>\n"
                    + "                <br>\n"
                    ...
                    + "        \n"
                    + "        <!--PREGUNTA 5-->\n"
                    + "        <form class=\"login-form\" action=\"ProcessTest2\" method=\"post\">\n"
                    + "            <p class=\"login-head\">PREGUNTA 5</p>\n"
                    + "            <br>\n"
                    + "            <p class=\"login-head-text\">\n"
                    + "                Escoge la respuesta correcta. El comando \"fg\" trae un proceso que se está"
                    + "        ejecutando en segundo plano a primer plano.</p>\n"
                    + "            <br>\n"
                    + "            <hr>\n"
                    + "            <br>\n"
                    + "            <p>" + correct_mess + "</p>"
                    + "            <br>\n"
                    + "            <input class=\"login-button\" type=\"submit\" value=\"Terminar\">\n"
                    + "        </form>\n"
                    + "    </body>\n"
                    + "</html>");
            out.close();
