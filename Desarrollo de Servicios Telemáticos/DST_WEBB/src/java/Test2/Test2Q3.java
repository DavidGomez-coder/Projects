 ...
 * @author dgpv2
 */
@WebServlet(name = "Test2Q3", urlPatterns = {"/Test2Q3"})
public class Test2Q3 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (userName != null) {
            ...
            out.println("<!DOCTYPE html>\n"
                    ...
                    + "        \n"
                    + "        <!--PREGUNTA 3-->\n"
                    + "        <form class=\"login-form\" action=\"ProcessQuestion3T2\"\n"
                    + " name=\"T1Form\" value=\"T1Q3\" method=\"post\">\n"
                    + "            <p class=\"login-head\">PREGUNTA 3</p>\n"
                    + "            <br>\n"
                    + "            <p class=\"login-head-text\">\n"
                    + "                Escoge la respuesta correcta. La sentencia \"kill -a\" muestra la lista de todas las señales"
                            + "        que se pueden enviar.</p>\n"
                    + "            <br>\n"
                    + "            <hr>\n"
                    + "            <br>\n"
                    + "            <div>\n"
                    + "                <label><input type=\"radio\" name=\"T2Q3\" value=\"SI\"> a) SI</label><br>\n"
                    + "                <label><input type=\"radio\" name=\"T2Q3\" value=\"NO\"> b) NO</label><br>\n"
                    + "                <label><input type=\"radio\" name=\"T2Q3\" value=\"A VECES\"> c) A VECES</label><br>\n"
                    + "            </div>\n"
                    + "            <br>\n"
