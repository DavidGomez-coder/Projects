 ...
 * @author dgpv2
 */
@WebServlet(urlPatterns = {"/Test2Q1"})
public class Test2Q1 extends HttpServlet {
        ...
        if (userName != null) {
            ...
            out.println("<!DOCTYPE html>\n"
                   ...
                   + "         <font color=\"white\"><b>Nº aciertos:</b></font> <font color=\"#6DC36D\"><b>" + ok_q + "</b></font>\n "
                    ...
                    + "        \n"
                    + "        <!--PREGUNTA 1-->\n"
                    + "        <form class=\"login-form\" action=\"ProcessQuestion1T2\"\n"
                    + " name=\"T1Q1Form\" method=\"post\">\n"
                    + "            <p class=\"login-head\">PREGUNTA 1</p>\n"
                    + "            <br>\n"
                    + "            <p class=\"login-head-text\">\n"
                    + "                Escoge la respuesta correcta. Al ejecutar el comando \"ps\", se visualizarán "
                           + "         los procesos activos.</p>\n"
                    + "            <br>\n"
                    + "            <hr>\n"
                    + "            <br>\n"
                    + "            <div>\n"
                    + "                <label><input type=\"radio\" name=\"T2Q1\" value=\"SI\"> a) SI</label><br>\n"
                    + "                <label><input type=\"radio\" name=\"T2Q1\" value=\"NO\"> b) NO</label><br>\n"
                    + "                <label><input type=\"radio\" name=\"T2Q1\" value=\"A VECES\"> c) A VECES</label><br>\n"
                    + "            </div>\n"
                    + "            <br>\n"
