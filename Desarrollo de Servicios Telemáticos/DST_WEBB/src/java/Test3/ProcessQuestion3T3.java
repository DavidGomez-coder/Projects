 ...
 * @author dgpv2
 */
@WebServlet(name = "ProcessQuestion3T3", urlPatterns = {"/ProcessQuestion3T3"})
public class ProcessQuestion3T3 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (userName != null) {
            ...
            out.println("<!DOCTYPE html>\n"
                    ...
                    + "        \n"
                    + "        <!--PREGUNTA 3-->\n"
                    + "        <form class=\"login-form\" action=\"Test3Q4\" method=\"post\">\n"
