 ...
 * @author dgpv2
 */
@WebServlet(name = "ProcessQuestion5T3", urlPatterns = {"/ProcessQuestion5T3"})
public class ProcessQuestion5T3 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (userName != null) {
            ...
            out.println("<!DOCTYPE html>\n"
                    ...
                    + "        \n"
                    + "        <!--PREGUNTA 5-->\n"
                    + "        <form class=\"login-form\" action=\"ProcessTest3\" method=\"post\">\n"
