    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        if (userName != null) {
            ...
            out.println("<!DOCTYPE html>\n"
                    ...
                    + "        \n"
                    + "        <!--PREGUNTA 1-->\n"
                    + "        <form class=\"login-form\" action=\"Test3Q2\" method=\"post\">\n"
                    + "            <p class=\"login-head\">PREGUNTA 1</p>\n"
                    + "            <br>\n"
                    + "            <p class=\"login-head-text\">\n"
                    + "                Escoge la respuesta correcta. El comando \"ping dominio\" permite saber si el dominio"
                    + "         pasado como parámetro es alcanzable.</p>\n"
                    + "            <br>\n"
                    + "            <hr>\n"
                    + "            <br>\n"
                    + "            <p>" + correct_mess + "</p>"
