 ...
 * @author dgpv2
 */
@WebServlet(name = "Test3Main", urlPatterns = {"/Test3Main"})
public class Test3Main extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (loginName != null) {
            ...
            out.println("<html>\n"
                    ...
                    + "                <br>\n"
                    + "                <li><div style=\"text-align: center\"><a href=\"#\">Test 3</a></div></li>\n"
                    ...
                    + "        <br><br>\n"
                    + "        <h2 style=\"text-align: center; color: white;\">Información acerca del TEST 3</h2>\n "
                    + "        <form class=\"login-form\" action=\"Test3Q1\">"
                    + "        <p class=\"login-head-text\">Este es el tercer test. Aquí se pondrán a prueba tus conocimientos sobre "
                            + " algunos comandos usados en la administración de redes. Se recomienda leer"
