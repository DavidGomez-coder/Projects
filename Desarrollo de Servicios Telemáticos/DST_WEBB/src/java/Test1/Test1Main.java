 ...
 * @author dgpv2
 */
@WebServlet(name = "Test1Main", urlPatterns = {"/Test1Main"})
public class Test1Main extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (loginName != null) {
            ...
            out.println("<html>\n"
                    ...
                    + "                <br>\n"
                    + "                <li><div style=\"text-align: center\"><a href=\"#\">Test 1</a></div></li>\n"
                    + "                <br>\n"
                    ...
                    + "        <br><br>\n"
                    + "        <h2 style=\"text-align: center; color: white;\">Información acerca del TEST 1</h2>\n "
                    + "        <form class=\"login-form\" action=\"Test1Q1\">"
                    + "        <p class=\"login-head-text\">Este primer test se basa en cinco preguntas sobre distintos comandos sobre"
                    + "             terminales en varios sistemas operativos, por ejemplo, para la ejecución de programas usando la terminal. Se recomienda leer"
                    ...
                    + "         <input class=\"login-button\" type=\"submit\" value=\"Continuar con el test\">\n"
                            ...
                            + "<div style=\"text-align: center\"><a href=\"https://docs.microsoft.com/es-es/documentation/\">Comandos Windows</a></div>"
                    + "</form>\n"
                    + "        <br><br>\n"
                    + "        \n"
                    + "        \n"
