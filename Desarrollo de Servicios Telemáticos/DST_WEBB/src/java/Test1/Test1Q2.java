 ...
 * @author dgpv2
 */
@WebServlet(name = "Test1Q2", urlPatterns = {"/Test1Q2"})
public class Test1Q2 extends HttpServlet {
        ...
        if (userName != null) {
            ...
            out.println("<!DOCTYPE html>\n"
                   ...
                   + "         <font color=\"white\"><b>Nº aciertos:</b></font> <font color=\"#6DC36D\"><b>" + ok_q + "</b></font>\n "
                    ...
                    + "        \n"
                    + "        <!--PREGUNTA 2-->\n"
                    + "        <form class=\"login-form\" action=\"ProcessQuestion2\"\n"
                    ...
                    + "            <br>\n"
                    + "            <div>\n"
                    + "                <label><input type=\"radio\" name=\"T1Q2\" value=\"SI\"> a) SI</label><br>\n"
                    + "                <label><input type=\"radio\" name=\"T1Q2\" value=\"NO\"> b) NO</label><br>\n"
                    + "                <label><input type=\"radio\" name=\"T1Q2\" value=\"A VECES\"> c) A VECES</label><br>\n"
                    + "            </div>\n"
                    + "            <br>\n"
