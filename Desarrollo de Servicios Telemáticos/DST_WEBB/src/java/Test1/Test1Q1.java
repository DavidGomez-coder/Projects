 ...
 * @author dgpv2
 */
@WebServlet(urlPatterns = {"/Test1Q1"})
public class Test1Q1 extends HttpServlet {
        ...
        if (userName != null) {
            ...
            out.println("<!DOCTYPE html>\n"
                   ...
                   + "         <font color=\"white\"><b>Nº aciertos:</b></font> <font color=\"#6DC36D\"><b>" + ok_q + "</b></font>\n "
                    ...
                    + "        \n"
                    + "        <!--PREGUNTA 1-->\n"
                    + "        <form class=\"login-form\" action=\"ProcessQuestion1\"\n"
                    ...
                    + "            <br>\n"
                    + "            <div>\n"
                    + "                <label><input type=\"radio\" name=\"T1Q1\" value=\"SI\"> a) SI</label><br>\n"
                    + "                <label><input type=\"radio\" name=\"T1Q1\" value=\"NO\"> b) NO</label><br>\n"
                    + "                <label><input type=\"radio\" name=\"T1Q1\" value=\"A VECES\"> c) A VECES</label><br>\n"
                    + "            </div>\n"
                    + "            <br>\n"
