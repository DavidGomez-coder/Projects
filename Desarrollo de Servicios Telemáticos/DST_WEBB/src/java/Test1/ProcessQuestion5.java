 ...
 * @author dgpv2
 */
@WebServlet(name = "ProcessQuestion5", urlPatterns = {"/ProcessQuestion5"})
public class ProcessQuestion5 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (userName != null) {
            ...
            out.println("<!DOCTYPE html>\n"
                    ...
                    + "        \n"
                    + "        <!--PREGUNTA 5-->\n"
                    + "        <form class=\"login-form\" action=\"ProcessTest1\" method=\"post\">\n"
                    + "            <p class=\"login-head\">PREGUNTA 5</p>\n"
                    + "            <br>\n"
                    + "            <p class=\"login-head-text\">\n"
                    + "                Escoge la respuesta correcta. En el sistema operativo Windows, el comando "
                    + "        \"route print\", imprime por pantalla la ruta del fichero \"print\" situado"
