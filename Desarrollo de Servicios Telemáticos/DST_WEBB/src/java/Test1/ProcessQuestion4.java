 ...
 * @author dgpv2
 */
@WebServlet(name = "ProcessQuestion4", urlPatterns = {"/ProcessQuestion4"})
public class ProcessQuestion4 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (userName != null) {
            ...
            out.println("<!DOCTYPE html>\n"
                    ...
                    + "        \n"
                    + "        <!--PREGUNTA 4-->\n"
                    + "        <form class=\"login-form\" action=\"Test1Q5\" method=\"post\">\n"
