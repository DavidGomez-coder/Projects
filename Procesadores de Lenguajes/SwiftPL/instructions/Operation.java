...
public class Operation implements Instruction{
	...
	/* 
		Constructor para la creación de arrays 
		@a    array
	*/
	...
	/*
		Constructor para el acceso a un índice de un array
		@varName       nombre de la variable
		@arrayIndex    índice
		@operationType indica el tipo de operación, en este caso será Global.VARIABLE
	*/
	...
	/* 
		...
		@left     Operación de la iquierda
		@operator operador
		@right    Operación de la derecha
	*/
	...
	*/
	...
	/* 
		Acceso a variables 
		@varName	   nombre de la variable
		@operationType tipo de operación (en este caso es Global.VARIABLE)
	*/
