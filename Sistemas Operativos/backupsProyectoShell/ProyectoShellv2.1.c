...
int main(void)
{
	  ...
	  job * jobs = new_list("Procesos en segundo plano");
	...
	//pasamos a primer plano la tarea de jobs indicada como segundo parámetro
	//si es NULL, pasamos a fg el último comando introducido
	}else if (strcmp(args[0],"fg")==0){

	//pasamos de stopped a running el proceso pasado como segundo argumento
	}else if (strcmp(args[0],"bg")==0){
		if (args[1]==NULL){
			printf(COLOR_RED"NO se ha indicado el proceso de la lista de trabajos que se quiere reanudar\n"COLOR_RESET);
		}else{
